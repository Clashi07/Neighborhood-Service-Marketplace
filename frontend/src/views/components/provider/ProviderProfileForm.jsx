  ...
  return (
    <Card className="border-0 shadow-sm">
      <Card.Body className="p-4">
        {/* TOP HEADER: Browse Categories and Home Button */}
        ...
        <Form onSubmit={handleSubmit}>
          ...
          {/* SCROLLABLE DROPDOWN (Replaces the large list) */}
          <Form.Group className="mb-4 position-relative" ref={dropdownRef}>
            <Form.Label className="fw-bold text-dark">Select Service</Form.Label>
            <div 
            ...
            >
              <span className={formData.specializations[0] ? "text-dark" : "text-muted"}>
                {formData.specializations[0]?.name || "Select from categories..."}
              </span>
            ...
            {showDropdown && (
              ...
              >
                {categories.map((cat, i) => (
                  <div 
                    key={i} 
                    className="p-3 border-bottom service-item-hover" 
